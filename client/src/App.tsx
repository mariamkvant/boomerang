...
function Navbar() {
  ...
  return (
    <nav className="bg-white/95 dark:bg-[#1e1b18]/95 backdrop-blur-xl border-b border-gray-100/80 dark:border-gray-800 fixed top-0 left-0 right-0 z-50 lg:sticky lg:top-0" style={{ boxShadow: '0 1px 0 rgba(0,0,0,0.06)' }}>
        ...
        <div className="hidden lg:flex items-center gap-3">
          {user ? (
            <>
              ...
              <div className="relative">
                <button onClick={(e) => { e.stopPropagation(); setProfileOpen(!profileOpen); }}
                  className="w-9 h-9 rounded-full bg-[#1f2937] text-white font-semibold text-sm flex items-center justify-center hover:bg-[#111827]">
            ...
            <>
              ...
              <Link to="/register" className="text-sm font-medium bg-[#1f2937] text-white px-4 py-2 rounded-lg hover:bg-[#111827]">Sign up free</Link>
            </>
          )}
        </div>
...
export default function App() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <Navbar />
      <main className="flex-1 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 w-full pb-24 lg:pb-6 pt-[4.5rem] lg:pt-6">
        <ErrorBoundary>
