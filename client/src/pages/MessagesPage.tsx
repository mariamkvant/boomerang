              ...
              <div className="px-3 py-2 bg-gray-100 dark:bg-[#202c33] shrink-0">
                ...
                <div className="flex gap-1.5 items-end">
                  ...
                  <button onClick={send} disabled={sending || (!newMsg.trim() && !pendingImage)}
                    className="w-11 h-11 bg-primary-500 text-white rounded-full flex items-center justify-center hover:bg-primary-600 disabled:opacity-40 shrink-0 shadow-sm">
