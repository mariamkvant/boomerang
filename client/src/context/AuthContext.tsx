...
interface User { id: number; username: string; email: string; points: number; bio: string; avg_rating: number | null; review_count: number; email_verified: boolean; is_admin?: boolean; city: string | null; latitude: number | null; longitude: number | null; languages_spoken: string | null; avatar?: string | null; }
