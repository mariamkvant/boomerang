      ...
      <div className="flex items-center justify-around h-[60px] max-w-lg mx-auto">
        ...
        {tab('/me', ['/me', '/dashboard', '/settings', '/account', '/availability'], t('nav.me'),
          <div className="relative">
            ...
            {pendingActions > 0 && <span className="absolute -top-1 -right-1 w-4 h-4 bg-red-500 text-white text-[9px] font-bold rounded-full flex items-center justify-center">{pendingActions > 9 ? '9+' : pendingActions}</span>}
          </div>,
          <div className="relative">
