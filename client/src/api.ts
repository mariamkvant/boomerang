...
export const api = {
  ...
  deliverRequest: (id: number, delivery_note?: string) => request(`/requests/${id}/deliver`, { method: 'PUT', body: JSON.stringify({ delivery_note }) }),
  ...
  rescheduleRequest: (id: number, body: any) => request(`/requests/${id}/reschedule`, { method: 'PUT', body: JSON.stringify(body) }),
  acceptReschedule: (id: number) => request(`/requests/${id}/reschedule/accept`, { method: 'PUT' }),
  ...
  tagService: (id: number, is_product: boolean) => request(`/admin/services/${id}/tag`, { method: 'PUT', body: JSON.stringify({ is_product }) }),
